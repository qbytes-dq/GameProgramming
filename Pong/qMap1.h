	...
	// corners
		...
		int num_ball = 8;
			...
			for (x=5;x<num_ball;x++)
				a_listwall->add_circle(xx9,xx9, x*13,   0, g_pDDSwall);
			for (x=5;x<num_ball;x++)
				a_listwall->add_circle(xx9,xx9, x*13, 90, g_pDDSwall);
			for (x=5;x<num_ball;x++)
				a_listwall->add_circle(xx9,xx9 ,x*13, 180, g_pDDSwall);
			for (x=5;x<num_ball;x++)
				a_listwall->add_circle(xx9,xx9 ,x*13, 270, g_pDDSwall);	
